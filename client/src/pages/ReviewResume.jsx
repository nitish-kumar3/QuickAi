...
//                 <button className='w-full flex justify-center item-center gap-2 bg-gradient-to-r from-[#00DA83] to-[#009BB3] text-white px-4 py-2 mt-6 text-sm rounded-lg cursor-pointer'>
//                     {
    ...
    return (
        <div className="h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700">
            ...
            <div className="w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200 flex flex-col min-h-96 max-h-[600px]">
                <div className="flex items-center gap-3">
                    <FileText className="w-5 text-[#009BB3]" />
                    <h1 className="text-xl font-semibold">Analysis Results</h1>
                </div>
