...
// //                 <button disabled={loading} className='w-full flex justify-center item-center gap-2 bg-gradient-to-r from-[#226BFF] to-[#65ADEF] text-white px-4 py-2 mt-6 text-sm rounded-lg cursor-pointer'>
// //                     {
...
// //                         <p>Enter a tropic and click "Generate article" to get started.</p>
// //                     </div>
// //                 </div>
// //                 ) : (
...
//             const prompt = `Write a detailed article on "${input}" with a length of ${selectedLength.text}.`
...
//                 <button
//                     disabled={loading}
//                     className='w-full flex justify-center items-center gap-2 bg-gradient-to-r from-[#226BFF] to-[#65ADEF] text-white px-4 py-2 mt-6 text-sm rounded-lg cursor-pointer'>
//                     {loading ? (
